...
| Submission media | Video improves judge access to an incident. | An eight-slide PDF and 45-second local demo were built from source commit `1c15dc8`; neither was uploaded to Devpost. | Do not claim superiority on video/pitch media without judge evidence. Keep the local artifact and hosted site status separate. |
