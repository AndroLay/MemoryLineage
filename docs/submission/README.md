...
| [Release candidate](https://github.com/AndroLay/MemoryLineage/releases/tag/v1.0.1-rc.3) | Tagged source, evidence, and reviewer artifacts |
...
candidate is published as [`v1.0.1-rc.3`](https://github.com/AndroLay/MemoryLineage/releases/tag/v1.0.1-rc.3).
