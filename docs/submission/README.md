...
| [Release candidate](https://github.com/AndroLay/MemoryLineage/releases/tag/v1.0.1-rc.2) | Tagged source, evidence, and reviewer artifacts |
...
candidate is published as [`v1.0.1-rc.2`](https://github.com/AndroLay/MemoryLineage/releases/tag/v1.0.1-rc.2).
A demo video, separate staging environment, and external human reproduction
are not claimed until their evidence is recorded.
